...
setenv("PYTHONPATH", pathJoin(TOOL_DEPENDENCIES,"gimmemotif/0.13.1/python3.6/site-packages/"))
local activate = "source activate " .. TOOL_DEPENDENCIES .. "/gimmemotif/0.13.1"
...
--local deactivate = "module load conda; source deactivate " .. TOOL_DEPENDENCIES .. "/gimmemotif/0.13.1; module unload conda"
